...
export default class Show_KartenModal extends React.Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <Button onClick={this.toggleModal} className="w-full" color="gray">
                ...
                >
                    ...
                    <Modal.Body>
                        <Tabs.Group
                            ...
                            color="dark"
                        >
                            <Tabs.Item title="Orthophotos">
                                <div className="w-full grid">
                                    <iframe
                                        width={600}
                                        height={400}
                                        src={
                                            "https://geoportal-hamburg.de/geo-online/?Map/layerIds=12883,12884,16101,19969,19968&visibility=true,true,true,true,true&transparency=0,0,0,0,0&Map/center=[" +
                                            result[0] +
                                            "," +
                                            result[1] +
                                ...
                                <div onLoad={(e) => console.log(e)}>
                                    <div className="w-full grid">
                                        <iframe
                                            ...
                                            height={400}
                                            src={
                                                "https://geoportal-hamburg.de/geo-online/?Map/layerIds=12883,12884,16101,19968,19969,368,2445&visibility=true,true,true,false,false,true,false&transparency=0,0,0,0,0,0,0&Map/center=[" +
                                                result[0] +
                                                "," +
                                                result[1] +
                                                "]&Map/zoomLevel=10&uiStyle=simple"
